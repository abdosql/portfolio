      ...
      <div className="container mx-auto py-12">
        ...
        <div className="mt-12">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <li className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">API Platform 3 - SymfonyCasts, March 2024</li>
            <li className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Doctrine, Symfony and Databases - SymfonyCasts, March 2024</li>
            <li className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Go Pro with Doctrine Queries - SymfonyCasts</li>
            <li className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Harmonious Development with Symfony 6 - SymfonyCasts</li>
            <li className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Symfony 6 Fundamentals: Services, Configuration and Environments - SymfonyCasts</li>
          </ul>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">PHP</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Symfony</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Laravel</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">JavaScript</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">React</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">MySQL</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">API Development</div>
            <div className="bg-gray-100 dark:bg-[#1e1e1e] p-4 rounded">Git</div>
          </div>
        </div>
      </div>
    </section>
